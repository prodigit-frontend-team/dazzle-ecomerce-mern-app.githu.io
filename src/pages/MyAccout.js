                    ...
                    <div className="col-lg-6 col-md-8">
                        <div className="inner">
                            <ul className="axil-breadcrumb">
                                <li className="axil-breadcrumb-item"><a href="index-2.html">Home</a></li>
                                ...
                                <div className="tab-pane fade" id="nav-downloads" role="tabpanel">
                                    ...
                                    <div className="table-responsive">
                                            <table className="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td ><a href="single-product.html"><img src="assets/images/product/electric/product-01.png" alt="Digital Product"/></a></td>
                                                        <td><a href="single-product.html">Wireless PS Handler</a></td>
                                                        <td><span class="currency-symbol">$</span>124.00</td>
                                                        <td>In Stock</td>
                                                        <td><Link to={"/cart"} className="axil-btn view-btn">Add Cart</Link></td>
                                                    </tr>
                                                    <tr>
                                                    <td ><a href="single-product.html"><img src="assets/images/product/electric/product-01.png" alt="Digital Product"/></a></td>
                                                        <td><a href="single-product.html">Wireless PS Handler</a></td>
